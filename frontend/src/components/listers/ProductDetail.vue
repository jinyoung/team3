<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="ProductSpec" v-model="item.productSpec" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="Qty" v-model="item.qty" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="ProductPrice" v-model="item.productPrice" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
