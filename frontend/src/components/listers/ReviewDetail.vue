<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Date label="ReviewDate" v-model="item.reviewDate" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="ModifiedDate" v-model="item.modifiedDate" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="Rating" v-model="item.rating" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="DeleteDate" v-model="item.deleteDate" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
