<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <Date label="ReviewDate" v-model="value.reviewDate" :editMode="editMode"/>
            <Date label="ModifiedDate" v-model="value.modifiedDate" :editMode="editMode"/>
            <Number label="Rating" v-model="value.rating" :editMode="editMode"/>
            <Date label="DeleteDate" v-model="value.deleteDate" :editMode="editMode"/>
        </v-card-text>
